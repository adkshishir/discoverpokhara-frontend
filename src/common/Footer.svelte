 ...
 <!-- Footer Start -->
        ...
        <div class="row py-4">
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="m-n1">
                    ...
                    <a href="{`${FRONTEND_URL}/category/${tag?.slug}`}" class="btn btn-sm btn-secondary m-1">{tag?.name}</a>
                    {/each}
                    {/if}
                </div>
            </div>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
        <p class="m-0 text-center">&copy; <a href='https://discoverpokhara.com'>Discover Pokhara</a>. All Rights Reserved. </p>
    </div>
    <!-- Footer End -->
