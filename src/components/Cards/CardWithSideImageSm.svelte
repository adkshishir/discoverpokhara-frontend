<script lang="ts">
    ...
    export let image = 'https://via.placeholder.com/110x110';
...
<div title="{title}" class="w-100 d-flex align-items-center bg-white mb-3" style="height: 110px;">
    <img class="img-fluid" style="width: 110px; height: 110px;object-fit:cover" src={image} alt="">
