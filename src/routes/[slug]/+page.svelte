				...
				<div class="d-flex justify-content-between">
					...
					>
						<div class="text-truncate">
							<a class="text-secondary text-uppercase font-weight-semi-bold" href=""
								>Lorem ipsum dolor sit amet elit. Proin interdum lacus eget ante tincidunt, sed
								faucibus nisl sodales</a
							>
						</div>
						<div class="text-truncate">
							<a class="text-secondary text-uppercase font-weight-semi-bold" href=""
				...
				<div class="position-relative mb-3">
					...
					<div class="bg-white border border-top-0 p-4">
						...
						<!-- <p>
							...
							accusam consetetur eirmod. Kasd accusam sit ipsum sadipscing et at at sanctus et.
							Ipsum sit gubergren dolores et, consetetur justo invidunt at et aliquyam ut et vero
							clita. Diam sea sea no sed dolores diam nonumy, gubergren sit stet no diam kasd vero.
						</p>
						<p>
							Voluptua est takimata stet invidunt sed rebum nonumy stet, clita aliquyam dolores vero
							stet consetetur elitr takimata rebum sanctus. Sit sed accusam stet sit nonumy kasd
							diam dolores, sanctus lorem kasd duo dolor dolor vero sit et. Labore ipsum duo sanctus
							amet eos et. Consetetur no sed et aliquyam ipsum justo et, clita lorem sit vero amet
							amet est dolor elitr, stet et no diam sit. Dolor erat justo dolore sit invidunt.
						</p>
						...
						<p>
							...
							invidunt at est sanctus sanctus. Clita dolores sit kasd diam takimata justo diam lorem
							sed. Magna amet sed rebum eos. Clita no magna no dolor erat diam tempor rebum
							...
							amet dolor ipsum vero ea ea eos. Invidunt sed diam dolores takimata dolor dolore
							dolore sit. Sit ipsum erat amet lorem et, magna sea at sed et eos. Accusam eirmod kasd
							lorem clita sanctus ut consetetur et. Et duo tempor sea kasd clita ipsum et.
						</p>
						...
						<p>
							...
							amet dolor ipsum vero ea ea eos. Invidunt sed diam dolores takimata dolor dolore
							dolore sit. Sit ipsum erat amet lorem et, magna sea at sed et eos. Accusam eirmod kasd
							lorem clita sanctus ut consetetur et. Et duo tempor sea kasd clita ipsum et. Takimata
							kasd diam justo est eos erat aliquyam et ut.
						</p> -->
					</div>
			...
			<div class="col-lg-4">
				...
				<div class="mb-3">
					...
					<div class="bg-white border border-top-0 p-3">
                        <SocialMediaCard logoClass="fab fa-facebook-f" backgroundColor="#39569C" fansCount="12,345" slug="https://www.facebook.com/"></SocialMediaCard>
                            <SocialMediaCard logoClass="fab fa-instagram" backgroundColor="#C8359D" fansCount="12,345" slug="https://www.instagram.com/"></SocialMediaCard>
                            <SocialMediaCard logoClass="fab fa-linkedin-in" backgroundColor="#0185AE" fansCount="12,345" slug="https://www.linkedin.com/"></SocialMediaCard>
                            <SocialMediaCard logoClass='fab fa-twitter' backgroundColor="#1DA1F2" fansCount="12,345" slug="https://www.twitter.com/"></SocialMediaCard>                     
                            <SocialMediaCard logoClass="fab fa-pinterest" backgroundColor="#BD081B" fansCount="12,345" slug="https://www.pinterest.com/"></SocialMediaCard>
                           <SocialMediaCard logoClass="fab fa-vimeo-v" backgroundColor="#055570" fansCount="12,345" slug="https://www.vimeo.com/"></SocialMediaCard>
						<!-- <a
							href=""
				...
				<div class="mb-3">
					...
					<div class="bg-white border border-top-0 p-3">
						...
						<div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
							<img class="img-fluid " style="max-width: 110px;height: 110px;object-fit:cover" src={relatedPost.image} alt="" />
							<div
